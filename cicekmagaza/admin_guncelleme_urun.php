...
if(isset($_POST['update_product'])){
   ...
   if(!empty($image)){
      if($image_size > 2000000){
         $message[] = 'resim dosyası boyutu çok büyük!';
      }else{
...
<form action="" method="post" enctype="multipart/form-data">
   ...
   <input type="text" class="box" value="<?php echo $fetch_products['name']; ?>" required placeholder="ürün adını güncelle" name="name">
   ...
   <input type="submit" value="ürün güncelleme" name="update_product" class="btn">
   <a href="admin_urunler.php" class="option-btn">geri git</a>
</form>

<?php
      }
   }else{
      echo '<p class="empty">Günceleme yapılan ürün yok</p>';
   }
?>
