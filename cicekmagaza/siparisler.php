...
<section class="heading">
    <h3>siparişlerin</h3>
    <p> <a href="Anasayfa.php">Anasayfa</a> / Sipariş </p>
</section>
...
<section class="placed-orders">
    ...
    ?>
    <div class="box">
        <p> gün: <span><?php echo $fetch_orders['placed_on']; ?></span> </p>
        ...
        <p> siparişlerin : <span><?php echo $fetch_orders['total_products']; ?></span> </p>
        <p> toplam fiyat : <span>TL<?php echo $fetch_orders['total_price']; ?>/-</span> </p>
        <p> ödeme durumu : <span style="color:<?php if($fetch_orders['odeme_durumu'] == 'bekleniyor'){echo 'tomato'; }else{echo 'green';} ?>"><?php echo $fetch_orders['odeme_durumu']; ?></span> </p>
    </div>
    <?php
        }
    }else{
