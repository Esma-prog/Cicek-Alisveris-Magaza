...
if(isset($_GET['delete'])){
   ...
   header('location:admin_kullanici.php');
}
...
<section class="users">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <a href="admin_kullanici.php?delete=<?php echo $fetch_users['id']; ?>" onclick="return confirm('bu kullanıcı silinsin mi?');" class="delete-btn">Sil</a>
      </div>
      <?php
         }
      }
