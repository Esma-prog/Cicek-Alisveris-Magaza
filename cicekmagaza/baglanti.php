...
<head>
   ...
   <title>Bağlantı(iletiişim)</title>
...
<section class="heading">
    <h3>bize ulaşın</h3>
    <p> <a href="Anasayfa.php">AnaSayfa</a> / Bağlantı </p>
</section>
...
<section class="contact">
    ...
    <form action="" method="POST">
        ...
        <input type="email" name="email" placeholder="E-postanızı giriniz" class="box" required>
        <input type="number" name="number" placeholder="numaranı gir" class="box" required>
