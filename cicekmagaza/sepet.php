...
<section class="shopping-cart">
    ...
    ?>
    <div  class="box">
        <a href="sepet.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('sepetten silinsin mi?');"></a>
        ...
        <div class="sub-total"> kısmi toplam: <span>TL<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
    </div>
    <?php
    ...
    <div class="more-btn">
        <a href="sepet.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled' ?>" onclick="return confirm('hepsi sepetten silinsin mi?');">hepsini sil</a>
    </div>

    <div class="cart-total">
        <p>Genel Toplam: <span>TL<?php echo $grand_total; ?>/-</span></p>
        <a href="alısveris.php" class="option-btn">alışverişe devam</a>
